...
namespace Randini
{
  ...
  //-------------------------------------------------------------------------------------------------
    ...
    switch (m_sortType)
      ...
      //praameters: takes in the interator to the beggining of the container,
      //the end of the container,
      //predict in which passes the function to stable sort which uses the function to sort
