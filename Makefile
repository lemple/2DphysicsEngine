#############################################################################
# Makefile for building: UniProjectTermTwo
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  UniProjectTermTwo.pro
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile UniProjectTermTwo.pro
#############################################################################
...
CXXFLAGS      = -pipe -mmacosx-version-min=10.7 -std=c++11 -stdlib=libc++ -std=c++1y -I/usr/local/include/SDL2 -D_REENTRANT -g -std=c++11 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-clang -I. -I/usr/local/include -I/src/ -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtCore -I.
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/Qt/5.3/gcc_64 -Wl,-rpath,/opt/Qt/5.3/gcc_64/lib
LIBS          = $(SUBLIBS) -mmacosx-version-min=10.7 -stdlib=libc++ -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lglew -framework OpenGL -L/opt/Qt/5.3/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		src/Randini/Timer.cpp \
		src/Randini/Window.cpp
QMAKE_TARGET  = UniProjectTermTwo
...
Makefile: UniProjectTermTwo.pro /opt/Qt/5.3/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile UniProjectTermTwo.pro
...
dist: 
	@test -d .tmp/UniProjectTermTwo1.0.0 || mkdir -p .tmp/UniProjectTermTwo1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/UniProjectTermTwo1.0.0/ && $(COPY_FILE) --parents src/Randini/GLSLProgram.h src/Randini/Camera2D.h src/Randini/Errors.h src/Randini/GLTexture.h src/Randini/ImageLoader.h src/Randini/InputControl.h src/Randini/IOManager.h src/Randini/picoPNG.h src/Randini/Randini.h src/Randini/ResourceManager.h src/Randini/Sprite.h src/Randini/SpriteLoader.h src/Randini/TextureCache.h src/Randini/Timer.h src/Randini/Vertex.h src/Randini/Window.h src/Uni/Ball.h src/Uni/BallControl.h src/Uni/BallRenderer.h src/Uni/BallGrid.h src/Uni/MainGame.h .tmp/UniProjectTermTwo1.0.0/ && $(COPY_FILE) --parents src/Uni/main.cpp src/Uni/Ball.cpp src/Uni/BallControl.cpp src/Uni/BallRenderer.cpp src/Uni/BallGrid.cpp src/Uni/MainGame.cpp src/Randini/GLSLProgram.cpp src/Randini/Camera2D.cpp src/Randini/Errors.cpp src/Randini/ImageLoader.cpp src/Randini/InputControl.cpp src/Randini/IOManager.cpp src/Randini/picoPNG.cpp src/Randini/Randini.cpp src/Randini/ResourceManager.cpp src/Randini/Sprite.cpp src/Randini/SpriteLoader.cpp src/Randini/TextureCache.cpp src/Randini/Timer.cpp src/Randini/Window.cpp .tmp/UniProjectTermTwo1.0.0/ && (cd `dirname .tmp/UniProjectTermTwo1.0.0` && $(TAR) UniProjectTermTwo1.0.0.tar UniProjectTermTwo1.0.0 && $(COMPRESS) UniProjectTermTwo1.0.0.tar) && $(MOVE) `dirname .tmp/UniProjectTermTwo1.0.0`/UniProjectTermTwo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/UniProjectTermTwo1.0.0
...
Ball.o: src/Uni/Ball.cpp src/Uni/Ball.h \
		/usr/local/include/glm/glm.hpp \
		/usr/local/include/glm/core/_fixes.hpp \
		/usr/local/include/glm/core/setup.hpp \
		/usr/local/include/glm/core/_detail.hpp \
...
BallControl.o: src/Uni/BallControl.cpp src/Uni/BallControl.h \
		src/Uni/Ball.h \
		/usr/local/include/glm/glm.hpp \
		/usr/local/include/glm/core/_fixes.hpp \
		/usr/local/include/glm/core/setup.hpp \
...
BallRenderer.o: src/Uni/BallRenderer.cpp src/Uni/BallRenderer.h \
		src/Randini/SpriteLoader.h \
		src/Randini/Vertex.h \
		/usr/local/include/glm/glm.hpp \
		/usr/local/include/glm/core/_fixes.hpp \
...
BallGrid.o: src/Uni/BallGrid.cpp src/Uni/BallGrid.h \
		src/Uni/Ball.h \
		/usr/local/include/glm/glm.hpp \
		/usr/local/include/glm/core/_fixes.hpp \
		/usr/local/include/glm/core/setup.hpp \
...
MainGame.o: src/Uni/MainGame.cpp src/Uni/MainGame.h \
		src/Randini/Camera2D.h \
		/usr/local/include/glm/glm.hpp \
		/usr/local/include/glm/core/_fixes.hpp \
		/usr/local/include/glm/core/setup.hpp \
